...
public class FileIOService {
    ...
    public List<String> readFile(String fileName) throws IOException{
        ...
        String filePath = "C:/Users/Rocky/Desktop/mavenExercise/maven-one/data/" + fileName;
	...
	public void writeFile(String newFileContent) throws IOException{
		FileWriter writer  = new FileWriter("C:/Users/Rocky/Desktop/mavenExercise/maven-one/data/newFile.txt");
